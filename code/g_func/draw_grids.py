...
def draw_player_grid(player_grid):
    for row in range(10):
        for column in range(10):
            pygame.draw.rect(init_screen.screen, player_grid[row][column].color, player_grid[row][column].rectangle)
...
def draw_enemy_grid(enemy_grid):
    for row in range(10):
        for column in range(10):
            pygame.draw.rect(init_screen.screen, enemy_grid[row][column].color, enemy_grid[row][column].rectangle)
